...
const HowItWorks = () => {
  return (
    <section className="relative z-10 overflow-hidden bg-gradient-to-b from-slate-50/50 via-white to-white py-20 dark:from-slate-900/50 dark:via-slate-900 dark:to-slate-900 lg:py-28">
      <div className="container relative">
        ...
        <div className="mx-auto mb-16 max-w-[620px] text-center lg:mb-20">
          ...
          <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400 sm:text-xl sm:leading-relaxed">
            EduVerse platformasida ta'lim olish va o'qitish jarayoni oddiy va qulay
          </p>
        </div>
        ...
        <div className="mb-24">
          <div className="mb-12 text-center">
            <h3 className="relative inline-block text-2xl font-bold text-slate-900 dark:text-white sm:text-3xl">
              👨‍🎓 O'quvchilar uchun
              <div className="absolute -bottom-2 left-0 h-1 w-full bg-gradient-to-r from-primary/50 to-primary/0" />
            </h3>
          </div>
