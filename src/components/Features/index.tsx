...
const Features = ({ showAll = false }: { showAll?: boolean }) => {
  ...
  return (
    <PageWrapper>
      <section id="features" className="relative z-10 overflow-hidden bg-gradient-to-b from-slate-50 via-slate-100/80 to-slate-50 py-16 dark:from-dark/50 dark:via-dark dark:to-dark/50 lg:py-24">
