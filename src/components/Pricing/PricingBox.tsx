const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div className="shadow-pricing hover:shadow-pricing-hover relative z-10 rounded-xl bg-white px-8 py-10 dark:bg-gray-dark">
        <div className="flex flex-col items-start">
          ...
          <h3 className="price mb-6 text-[32px] font-bold text-black dark:text-white">
            {price === "Maxsus" ? (
              <span className="amount">Maxsus</span>
            ) : (
              <>
        ...
        <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 dark:border-white dark:border-opacity-10">
          <button className="flex w-full items-center justify-center rounded-lg bg-primary p-3 text-base font-semibold text-white transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp">
            {price === "Maxsus" ? "Contact Us" : "Start Free Trial"}
          </button>
        </div>
